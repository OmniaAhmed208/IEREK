...
class StudyabroadAttendanceController extends Controller
{
    //
	public function filter($event_id, $deleted)
    {
        ...
        switch($deleted)
        {
            case "active-only";
                ...
                return View('admin.events.studyabroad.attendance.index')->with(array(
            		'event' => $eventTitle,
    ...
    public function export(Request $request)
    {
        ...
        switch($filter)
        {
            case 'all':
                $event = Events::where('event_id',$event_id)->first();
                $attendance = EventAttendance::where('event_id',$event_id)->get();
                return View('admin.events.studyabroad.attendance.export')->with(array(
                    'attendances' => $attendance,
                    'type' => 'All',
                    'event' => $event
                ));
