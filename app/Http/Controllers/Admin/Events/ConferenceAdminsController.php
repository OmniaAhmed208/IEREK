...
class ConferenceAdminsController extends Controller
{
    //
    public function show($id)
    {
    	...
    	$uAdmins = Users::whereIn('user_type_id', [2,3,5])->whereNotIn('user_id', $eAdminsIds)->where('deleted', 0)->get();
    	return view('admin.events.conference.admins.show')->with(array('eAdmins' => $eAdmins, 'uAdmins' => $uAdmins, 'event' => $event));
    }
    ...
    public function update(Request $request, $id)
    {
    	...
    	return redirect(route('showConferenceAdmins', $id));
    }
}
