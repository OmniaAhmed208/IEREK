...
class StudiesAdminsController extends Controller
{
    //
    public function show($id)
    {
    	...
    	return view('admin.events.studies.admins.show')->with(array('eAdmins' => $eAdmins, 'uAdmins' => $uAdmins, 'event' => $event));
    }
    ...
    public function update(Request $request, $id)
    {
    	...
    	return redirect(route('showStudiesAdmins', $id));
    }
}
