...
class StudyabroadFeesController extends Controller
{
    //
    public function show($event_id)
    {
        ...
        return view('admin.events.studyabroad.fees.show')->with(
            array(
            'fees' => $fees, 
            'event_id' => $event_id,
            'event' => $eventTitle,
    ...
    public function filter($event_id, $deleted)
    {
        ...
        switch($deleted)
        {
            case "active-only";
                ...
                return View('admin.events.studyabroad.fees.show')->with(array('fees' => $fees) )->with('select','active-only')->with('event_id', $event_id)->with(
            ...
            case "inactive-only";
                ...
                return View('admin.events.studyabroad.fees.show')->with(array('fees' => $fees) )->with('select','inactive-only')->with('event_id', $event_id)->with(
            'event_currency', $event['currency'])->with(array(
            'event' => $eventTitle
            ));
            break;
            case "all";
                ...
                return View('admin.events.studyabroad.fees.show')->with(array('fees' => $fees) )->with('select','all')->with('event_id', $event_id)->with(
            'event_currency', $event['currency'])->with(array(
            'event' => $eventTitle
            ));
            break;
    ...
    public function create($event_id)
    {
        ...
        $event = Events::where('event_id', $event_id)->firstOrFail();
        $eventTitle = $event['title_en'];
        return view('admin.events.studyabroad.fees.create')->with(
            array(
            'for' => $for, 
            'condition' => $condition, 
            'category' => $category, 
    ...
    public function edit($id)
    {
        ...
        $event = Events::where('event_id', $event_id)->firstOrFail();
        $eventTitle = $event['title_en'];
        return view('admin.events.studyabroad.fees.edit')->with(
            array(
                'fee' => $fees,
                'for' => $for, 
                'condition' => $condition, 
    ...
    {
        $data = $request->all();
        $event = Events::where('event_id',$event_id)->first(['currency']);
        ...
        {
            //new Conference Fees
            // Store the new conference fees data...
    ...
    public function update(Request $request, $id)
    {
        ...
        {
            //Update Conference Fees
            // Update the conference fees data...
