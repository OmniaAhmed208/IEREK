...
@section('content')
    <div id="CONFERENCEP">
        <div class="container conferences-page-container">
            ...
            <div class="margin-btm-30-mob">
                <div class="framed-box frame-box-mobile" style=" margin-bottom: 2%;">
                    ...
                    <div class="mCustomScrollbar brief-description">
                            <p>Conferences are well-known devices for bringing communities together, 
                            both for the formal and the informal exchanges they promote.
                            <br>
                            IEREK plans and organizes numerous conferences annually, 
                            in order to bring together academics and policymakers. 
                            <br>
                            Very reputable universities become partners to these conferences, 
                            and outstanding key speakers are invited to contribute with their success.
                            <br>
                            Organizing a conference involves several phases: – Creating an organizing structure. 
                            – Putting together staff to organize and run the conference, and planning how they will work together. 
                            – Planning the conference. – Publicizing the conference and recruiting and registering participants. 
                            – Running the conference. – Evaluating the conference and the conference-organizing process.</p>
                    </div>
                </div>
            ...
            <div class="tabsyears">
                ...
                <ul class="nav nav-tabs" role="tablist">
                        ...
                        @if($conferenceYear->title==date('Y'))
                            ...
                            <li role="presentation" class="active navs" data-year="{{$conferenceYear->title}}"><a
                                        class="nav-styles"
                                        ...
                                        data-toggle="tab">{{$conferenceYear->title}}
                                        </a></li>

                        @elseif($eventsCount == 0 && $conferenceYear->title==date('Y')+1)
                        <li role="presentation" class="active navs" data-year="{{$conferenceYear->title}}"><a
                                        class="nav-styles"
                                        href="#{{$conferenceYear->title}}"
                                        onclick="window.open('#{{$conferenceYear->title}}', '_self')"
                        ...
                        @else
                            <li role="presentation" class="navs" data-year="{{$conferenceYear->title}}"><a
                                        class="nav-styles"
                                        href="#{{$conferenceYear->title}}"
                                        onclick="window.open('#{{$conferenceYear->title}}', '_self')"
                                        aria-controls="con{{$conferenceYear->sub_category_id}}" role="tab"
                ...
                <div class="tab-content">
                    ...
                    @foreach($conferenceYears as $conferenceYear)
                        @if($conferenceYear->title == date('Y') && $eventsCount != 0 )
                            <div role="tabpanel" class="tab-pane active" id="{{$conferenceYear->title}}">
                                 @elseif($conferenceYear->title==date('Y')+1 && $eventsCount == 0 )
                            <div role="tabpanel" class="tab-pane active" id="{{$conferenceYear->title}}">
                                @else
                                    <div role="tabpanel" class="tab-pane " id="{{$conferenceYear->title}}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row">
                                                    <div class="conferencesContainer" style="flex-wrap: wrap; display: flex;"> 
                                                        ...
                                                        @foreach($finished as $eventList)
                                                            @if($eventList->sub_category_id==$conferenceYear->sub_category_id)
                                                                <div class="col-md-4">
                                                                    ...
                                                                    <div class="featured-conferences-item conferences-page-conf-container finishedConference"
                                                                         style=" float: left; list-style: outside none none; position: relative;width: 100%;margin:5px; ">
                                                                        <div>
                                                                            <a class="conference-content-container"
                                                                               href="{{ url('events/') }}{{ '/'.$eventList->slug }}">
                                                                                <div class="featured-conferences-item-thumb">
