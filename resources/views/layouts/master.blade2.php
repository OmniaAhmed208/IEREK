...
<!--                        <li class="menu-item" class="activition" data-url="conferences"><a
                ...
                {{--<li class="menu-item dropdown activition" data-url="projects_managemnet"><a href="/projects_managemnet">Project--}}
                {{--Management</a></li>--}}
                <li class="menu-item dropdown activition" data-url="scientific-committee"><a
                            href="/scientific-committee">Scientific Committee</a>
                </li>
                <li class="menu-item dropdown activition"><a href="#" data-toggle="dropdown" class="dropdown-toggle">Media<span
                                class="caret"></span></a>
                    <ul role="menu" class="dropdown-menu">
                        <li class="menu-item"><a href="/news/index.php/category/news/">Announcements</a></li>
                        <li class="menu-item"><a href="/news/index.php/category/blog/">Blog</a></li>
                    </ul>
                </li>
                ...
                {{--</ul>--}}
                {{--</li>--}}
                <li class="menu-item dropdown activition" data-url="contact-us"><a
                            href="/contact-us">
                        Contact Us
                    </a>
                </li>
                <li class="menu-item dropdown activition" data-url="faq"><a
                            href="/faq">
                        FAQ
                    </a>
                </li>
    ...
    <footer>
        ...
        <div class="container">
            ...
            <div class="row copyrights-row">
                ...
                <!-- Grid column -->
                <div class="col-xs-12 col-sm-4 copyright_container">
                    <!--Copyright-->

                    <div class="copyright-text">© 2020 Copyright:
                        <a target="_blank" href="https://www.ierek.com/">IEREK.COM</a>
                    </div>
