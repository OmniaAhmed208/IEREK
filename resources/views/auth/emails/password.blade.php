...
<html style="margin:0;padding:0;">
	...
	<div style="margin:0;padding:0;width:100%;margin:0 auto;height:auto;background-position:top;background-repeat:repeat-x;background-image:url(<?php echo $host; ?>/mailbg2.jpg)">
		...
		<div style="width:80%;max-width: 800px;height:auto;margin:0 auto;font-family:Verdana;background:rgba(255,255,255,0.7);padding:10px;color:#666;border:1px solid #999;">
			<div style="width:90%;margin:0 auto">
				<center><h1>Password Reset Request</h1></center>
				<p style="font-size:110%">
				Your requested password reset, kindly find link below to reset your password, if that wasn't you, simply delete this email.
				</br>
				<p style="font-size:110%">
				<a href="{{ $link = url('password/reset', $token).'?email='.urlencode($user->getEmailForPasswordReset()) }}"> Reset Password Link </a>
				</p>
			</div>
		</div>
