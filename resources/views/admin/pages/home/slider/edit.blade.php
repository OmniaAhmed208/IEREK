...
@section('panel-title')Update Slider Image 
@endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateSlider", $slider->slider_sid) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
            ...
            success: function (response) {
                ...
                else
                {
                    ...
                    setTimeout(
                        function(){
                            window.open('/admin/pages/home/slider/', '_self');
                            $('#success').fadeOut(200);
                        }
                    ,1000);
                }
                ...
                <div class="panel panel-default">                            
                    <div class="panel-body tab-content">
                            ...
                            <div class="form-group" id="position">
                                ...
                                <div class="col-md-7 col-xs-12"> 
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="position" id="position_input" class="form-control" value="{{ $slider->position }}"/>
                                    </div>
                                    <label id="position_err" class="help-block redl"></label>
                                </div>
                            </div>
                            
                            <img src="{{ $url['img'] }}" alt="No widget image uploaded" width="200">
                            ...
                            <div class="form-group" id="img_url">
                                ...
                                <div class="col-md-7 col-xs-12"> 
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="img_url" id="img_url_input" class="form-control" value="{{ $slider->img_url }}"/>
                                    </div>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Slider Image updated successfully !</strong> </span>
                        </div>
