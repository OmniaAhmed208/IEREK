@extends('admin.layouts.master') @section('return-url'){{route('indexFeaturedConferences')}}@endsection @section('panel-title')Add New Featured Conferences @endsection @section('content')
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/admin/pages/home/featured_conferences/store',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
                ...
                <div class="panel panel-default">
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Fill in featured_conferences information.</p>
                            <p>Fields with <span class="redl">*</span> is required.</p>
                            
                            <div class="form-group" id="featured_conference_type_id">
                                <label class="col-md-3 col-xs-12 control-label">Conference</label>
                                <div class="col-md-7 col-xs-12" data-toggle="tooltip" data-placement="left" title="Choose the Type of featured_conference">
                                    <select name="event_id" class="form-control select">
                                        @foreach($conferences as $conference)
                                        <option value="{{ $conference->event_id }}">{{ $conference->title_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Featured Conference added successfully !</strong> </span>
                        </div>
