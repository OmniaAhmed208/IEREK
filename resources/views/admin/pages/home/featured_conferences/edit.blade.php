...
@section('panel-title')Update Featured Conference 
@endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateFeaturedConference", $featuredConference->featured_event_sid) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
            ...
            success: function (response) {
                ...
                else
                {
                    ...
                    setTimeout(
                        function(){
                            window.open('/admin/pages/home/featured_conferences/', '_self');
                            $('#success').fadeOut(200);
                        }
                    ,1000);
                }
                ...
                <div class="panel panel-default">                            
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Update featured_conferences information.</p>
                            ...
                            <div class="form-group" id="event_id">                                        
                                ...
                                <div class="col-md-6 col-xs-12">
                                  <select class="form-control select" name="event_id">
                                        ...
                                        <!--<option value="0" selected="selected"> Choose Featured Conference Type</option>}-->
                                        
                                      
                                      @foreach($conferences as $conference)
                                        <option value="{{ $conference['event_id'] }}" @if($featuredConference->event_id == $conference['event_id']) {{ 'selected' }} @endif>{{ $conference['title_en'] }}  @if($featuredConference->event_id == $conference['event_id']) {{ '(Current)' }} @endif</option>
                                      @endforeach
                            ...
                            <div class="form-group" id="position">
                                ...
                                <div class="col-md-7 col-xs-12"> 
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="position" id="position_input" class="form-control" value="{{ $featuredConference->position }}"/>
                                    </div>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Featured Conferences updated successfully !</strong> </span>
                        </div>
