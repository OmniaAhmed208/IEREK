...
@section('panel-title')Update Featured Winter School 
@endsection
@section('content')
                ...
                <div class="panel panel-default">                            
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Update featured_winter_schools information.</p>
                            <p>Fields with <span class="redl">*</span> is required.</p>

                            <div class="form-group" id="event_id">                                        
                                <label class="col-md-3 col-xs-12 control-label">Winter School</label>
                                <div class="col-md-6 col-xs-12">
                                  <select class="form-control select" name="event_id">
                                      ...
                                      @foreach($winterSchools as $winterSchool)
                                        <option value="{{ $winterSchool['event_id'] }}" @if($featuredWinterSchool->event_id == $winterSchool['event_id']) {{ 'selected' }} @endif>{{ $winterSchool['title_en'] }}  @if($featuredWinterSchool->event_id == $winterSchool['event_id']) {{ '(Current)' }} @endif</option>
                                      @endforeach
                            ...
                            <div class="form-group" id="position">
                                ...
                                <div class="col-md-7 col-xs-12"> 
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="position" id="position_input" class="form-control" value="{{ $featuredWinterSchool->position }}"/>
                                    </div>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Featured Winter School updated successfully !</strong> </span>
                        </div>
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateFeaturedWinterSchools", $featuredWinterSchool->featured_event_sid) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
            ...
            success: function (response) {
                ...
                else
                {
                    ...
                    setTimeout(
                        function(){
                            window.open('/admin/pages/home/featured_winter_schools/', '_self');
                            $('#success').fadeOut(200);
                        }
                    ,1000);
                }
