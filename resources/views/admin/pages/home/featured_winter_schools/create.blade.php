@extends('admin.layouts.master') @section('return-url'){{route('indexFeaturedWorkshops')}}@endsection @section('panel-title')Add New Featured Winter Schools @endsection @section('content')
                ...
                <div class="panel panel-default">
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Fill in winter schools information.</p>
                            ...
                            <div class="form-group" id="featured_workshop_type_id">
                                ...
                                <div class="col-md-7 col-xs-12" data-toggle="tooltip" data-placement="left" title="Choose the Type of featured_workshop">
                                    <select name="event_id" class="form-control select">
                                        ...
                                        <option value="{{ $winterSchool->event_id }}">{{ $winterSchool->title_en }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Featured Winter School added successfully !</strong> </span>
                        </div>
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/admin/pages/home/featured_winter_schools/store',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
