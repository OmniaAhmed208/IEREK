...
@section('panel-title')Update Featured Workshop 
@endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateFeaturedWorkshop", $featuredWorkshop->featured_event_sid) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
            ...
            success: function (response) {
                ...
                else
                {
                    ...
                    setTimeout(
                        function(){
                            window.open('/admin/pages/home/featured_workshops/', '_self');
                            $('#success').fadeOut(200);
                        }
                    ,1000);
                }
                ...
                <div class="panel panel-default">                            
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Update featured_workshops information.</p>
                                ...
                                <div class="col-md-6 col-xs-12">
                                  <select class="form-control select" name="event_id">
                                      ...
                                      @foreach($workshops as $workshop)
                                        <option value="{{ $workshop['event_id'] }}" @if($featuredWorkshop->event_id == $workshop['event_id']) {{ 'selected' }} @endif>{{ $workshop['title_en'] }}  @if($featuredWorkshop->event_id == $workshop['event_id']) {{ '(Current)' }} @endif</option>
                                      @endforeach
                            ...
                            <div class="form-group" id="position">
                                ...
                                <div class="col-md-7 col-xs-12"> 
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="position" id="position_input" class="form-control" value="{{ $featuredWorkshop->position }}"/>
                                    </div>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Featured Workshops updated successfully !</strong> </span>
                        </div>
