...
@section('panel-title')Update Video Image 
@endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateVideo", $video->video_id) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
            ...
            success: function (response) {
                ...
                else
                {
                    ...
                    setTimeout(
                        function(){
                            window.open('/admin/pages/home/video/', '_self');
                            $('#success').fadeOut(200);
                        }
                    ,1000);
                }
                ...
                <div class="panel panel-default">                            
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            ...
                            <div class="form-group" id="position">
                                ...
                                <div class="col-md-7 col-xs-12"> 
                                    <div class="input-group">
                                        <input type="text" name="position" id="position_input" class="form-control" value="{{ $video->position }}"/>
                                    </div>
                            ...
                            <div class="form-group" id="img_url">
                                ...
                                <div class="col-md-7 col-xs-12"> 
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="redl"></span></span>
                                        <input type="text" name="img_url" id="img_url_input" class="form-control" value="{{ $video->url }}"/>
                                    </div>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Video Image updated successfully !</strong> </span>
                        </div>
