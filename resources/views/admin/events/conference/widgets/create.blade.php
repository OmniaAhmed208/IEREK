@extends('admin.layouts.master') @section('return-url'){{route('showConferenceWidgets', $event_id)}}@endsection @section('panel-title')Create New Widgets <small>{{ $event }}</small>@endsection @section('content')
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/admin/events/conference/widgets/store/{{ $event_id }}',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
                ...
                <div class="panel panel-default">
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Fill in conference widgets information.</p>
                            ...
                            <div class="form-group" id="widget_description">
                                ...
                                <div class="col-md-7 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"> <span class="redl"></span></span>
                                        <textArea name="widget_description" id="content" class="form-control textarea" ></textarea>
                                    </div>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Conference Widgets created successfully !</strong> </span>
                        </div>
    ...
    <div class="panel">
        <div class="panel-body">
            <table class="table table-stripped">
                <caption>Conference Widgets</caption>
                <thead>
                    <tr>
                        <th>Widget Title</th>
