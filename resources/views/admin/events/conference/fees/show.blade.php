...
<div class="page-content-wrap">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-2 pull-right">
                        <a href="/admin/events/conference/fees/create/{{ $event_id }}" class="btn btn-success btn-block"><span class="fa fa-plus"></span> Add Fees</a>
                    </div>
                    <div class="col-md-3">
                        <form method="get">
                                ...
                                <td>
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu" role="menu">
                                            <li><a href="{{ route('editConferenceFees', $afee->event_fees_id) }}" style="cursor:pointer">Edit</a></li>
                                            @if($afee->deleted == 0)
    ...
    window.open('/admin/events/conference/fees/{{ $event_id }}/filter/'+deleted, '_self')
    });
    ...
    $.ajax({
    type: 'POST',
    url: '/admin/events/conference/fees/restore/'+id,
    data: {_method: 'post'},
    ...
    $.ajax({
    type: 'POST',
    url: '/admin/events/conference/fees/'+id,
    data: {_method: 'delete'},
    beforeSend: function(xhr) {
