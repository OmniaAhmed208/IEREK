@extends('admin.layouts.master') @section('panel-title')Become a speaker <small>{{ $event }}</small>@endsection @section('content')
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/admin/events/conference/speakers/store/{{ $event_id }}',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
            ...
            success: function(response) {
                ...
                if (success == false) {
                    ...
                    setTimeout(
                        function() {
                            window.open('/admin/events/conference/speakers/{{ $event_id }}', '_self');
                            $('#success').fadeOut(200);
                        }, 1000);
                }
                $('#loading').fadeOut(200);
                ...
                <div class="panel panel-default">
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Fill in speakers information.</p>
                            ...
                            <div class="form-group" id="full_name">
                                ...
                                <div class="col-md-7 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="full_name" id="full_name_input" class="form-control" />
                                    </div>
                            ...
                            <div class="form-group" id="email">
                             ...
                             <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Image (High Resolution) <span class="redl">*</span></label>
                            ...
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">CV <span class="redl">*</span></label>
                                <div class="col-md-6 col-xs-12">                                                
                                    <input type="file" accept="image/*" class="image_file" name="cv" id="cv" class="form-control" />
                                </div>
                            </div>
                            <div class="form-group" id="brief_description">
                                <label class="col-md-3 col-xs-12 control-label">Brief about your lecture </label>
                                <div class="col-md-7 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"> <span class="redl"></span></span>
                           ...
                           <div class="form-group" id="university">
                                <label class="col-md-3 col-xs-12 control-label">University | Institute</label>
                                <div class="col-md-7 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"> <span class="red1"></span></span>
                                        <input type="text" name="university" id="university_input" class="form-control" />
                                    </div>
