...
@section('panel-title')Update Conference <small>{{ $event->title_en }} <?php if($event->deleted == 1){ echo '<b style="color:red">Deleted</b>'; } ?></small> @endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateConference", $event->event_id) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
                ...
                <div class="panel panel-default tabs">                            
                    ...
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            ...
                            <div class="form-group" id="title_en">
                                ...
                                <div class="col-md-6 col-xs-12"> 
                                   ...
                                   <div class="form-group" id="title_en">
                                <label class="col-md-3 col-xs-12 control-label">first link  image </label>


                                <div class="col-md-6 col-xs-12"> 
                                    <div class="input-group">
                                        <span class="input-group-addon">FI <span style="color:red">*</span></span>
                                        <input type="text" name="fimage" id="title_en_input" value="{{ $event->fimage }}" class="form-control"/>
                                    </div>
                                    <label id="title_en_err" class="help-block redl"></label> 
                                </div>
                            </div>
                                   ...
                                   <div class="form-group" id="title_en">
                                <label class="col-md-3 col-xs-12 control-label">secounf link image</label>
                                <div class="col-md-6 col-xs-12"> 
                                    <div class="input-group">
                                        <span class="input-group-addon">sl <span style="color:red">*</span></span>
                                        <input type="text" name="simage" id="title_en_input" value="{{ $event->simage }}" class="form-control"/>
                                    </div>
                                    <label id="title_en_err" class="help-block redl"></label> 
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">         
                                    ...
                                    <label class="check col-md-6"><input type="checkbox" class="icheckbox" name="egy" value="1" @if($event->egy == 1) {{ 'checked' }} @endif name="egy" value="1" /> Egyptian Fees</label>
                                </div>
                            </div>
                        ...
                        <div class="tab-pane fade" id="tab-downloads">
                            <p>Conference Downloads, Paper writing template.</p>
                            
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Writing Template</label>
                                <div class="col-md-6 col-xs-12">
                                    <a href="{{url('/storage/uploads/conferences/')}}{{'/'.$event->event_id}}{{'/'.$event->writing_template}}" target="_blank">Download</a>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <a href="{{url('/storage/uploads/conferences/')}}{{'/'.$event->event_id}}{{'/evaluation_sheet.pdf'}}" target="_blank">Download</a>
                                </div>
                            </div>
                            <div class="form-group">
