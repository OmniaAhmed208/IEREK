...
@section('panel-title') Export Conference Attendance <small>{{$event->title_en}}</small>@endsection
@section('return-url'){{'/admin/events/conference/attendance/'.$event->event_id}}@endsection
@section('content')
	<div class="row">
		<div class="panel">
					...
					<table id="customers" class="table datatable">
                        ...
                        <tbody>
                                @if(isset($attendances))
                                    ...
                                    @endforeach
                                @else
                                    {{ 'There is no attendances for this conferences filter' }}
                                @endif
                        </tbody>
					</table>
				</div>
	    ...
	    if(checked == true)
	    {
	        ...
	        processData: false,
	            ...
	            success: function (response) {
	            	...
	            	function ter()
	            	{
	            		// window.open('/admin/events/conference/attendance/{{$event->event_id}}','_self');
	            		$('#send').fadeIn();
	            	}
	            	$('#send').fadeOut();
