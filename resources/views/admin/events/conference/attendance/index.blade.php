                        ...
                        <div class="form-group panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">         
                                    ...
                                    <label class="check col-md-2"><input type="radio" class="icheckbox" value="co-authors" name="users_filter" /> Co-Authors</label>
                                    <label class="check col-md-2"><input type="radio" class="icheckbox" value="authors" name="users_filter" /> Authors</label>
...
<script type="text/javascript">
    $('#filter').on('change', function(event){
        ...
        window.open('/admin/events/conference/attendance/{{ $event_id }}/filter/'+deleted, '_self')
    });
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/conference/attendance/restore/'+id,
                        data: {_method: 'post'},
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/conference/attendance/'+id,
                        data: {_method: 'delete'},
                            beforeSend: function(xhr) {
