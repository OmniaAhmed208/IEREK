...
@section('panel-title')Manage Studies Attendance <small>{{ $event->title_en }}</small>@endsection
@section('content')	
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('ConAtteExport') }}">
                        ...
                        <div class="form-group panel">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-md-12">         
                                    ...
                                    <label class="check col-md-2"><input type="radio" class="icheckbox" value="audience" name="users_filter" /> Registered</label>
                                    <label class="check col-md-2 hidden"><input type="radio" class="icheckbox" value="co-authors" name="users_filter" /> Co-Authors</label>
                                    <label class="check col-md-2 hidden"><input type="radio" class="icheckbox" value="authors" name="users_filter" /> Authors</label>
        	...
        	<div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Studies Registered Users</h3>
                </div>
                <div class="panel-body">
            		<div class="col-md-6">
                        <form method="get">
                    ...
                    <table class="table table-hover table-striped datatable">
                        ...
                        <tbody>
                                @if(isset($attendances))
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="" class="hide" style="cursor:pointer">Add Payment</a></li>
                                                        <li><a href="" class="hide" style="cursor:pointer">Cancel Payment</a></li>
                                                        <li><a href="" onclick="windowOpen('{{url('admin/message/'.$attendance->user_id.'/'.$attendance->event_id)}}')" style="cursor:pointer">Message</a></li>
                                                        <li><a href="" onclick="windowOpen('{{url('admin/events/studies/application/'.$attendance->event_id.'/'.$attendance->user_id)}}')" style="cursor:pointer">Application</a></li>
                                                        {{-- @if($attendance->deleted == 0)
                                                            <li><a style="cursor:pointer;color:red" onClick="notyConfirmDel('{{ $attendance['users']->first_name }}', '{{ $attendance->event_attendance_id }}');">Remove</a></li>
                                    ...
                                    @endforeach
                                @else
                                    {{ 'There is no attendances for this studies' }}
                                @endif
                        </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    $('#filter').on('change', function(event){
        ...
        window.open('/admin/events/studies/attendance/{{ $event_id }}/filter/'+deleted, '_self')
    });
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/studies/attendance/restore/'+id,
                        data: {_method: 'post'},
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/studies/attendance/'+id,
                        data: {_method: 'delete'},
                            beforeSend: function(xhr) {
