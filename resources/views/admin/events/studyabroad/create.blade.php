...
@section('panel-title')Create New Studyabroad
@endsection
@section('content')
...
setTimeout(
function(){
window.open('/admin/events/studyabroad', '_self');
$('#success').fadeOut(200);
}
,1000);
}
                ...
                <div class="panel panel-default tabs">
                    ...
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Fill in study abroad general information.</p>
                            ...
                            <div class="form-group" id="sub_category_id">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <select class="form-control select" name="sub_category_id">
                                        ...
                                        <option value="{{ $category->sub_category_id }}">{{ $category->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="title_ar">
                                ...
                                <div class="col-md-6 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="title_ar" id="title_ar_input" value="" class="form-control"/>
                                    </div>
                                    <label id="title_ar_err" class="help-block redl"></label>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Study abroad Dates</label>
                                <div class="col-md-6 col-xs-12">
                                    <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="tab-Images">
                            <p>Insert Study abroad Images for all following views (Cover Image, Out View Image, Slider Image and Publisher Image.</p>
