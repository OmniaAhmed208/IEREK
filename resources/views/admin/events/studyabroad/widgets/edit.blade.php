...
@section('return-url'){{route('showStudyabroadWidgets', $event_id)}}@endsection
@section('panel-title')Update Studyabroad Widgets <small>{{ $event['title_en'] }}</small>
@endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateStudyabroadWidgets", $eventWidget->event_widget_sid) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
                ...
                <div class="panel panel-default">                            
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Update studyabroad widgets information.</p>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Studyabroad Widgets updated successfully !</strong> </span>
                        </div>
