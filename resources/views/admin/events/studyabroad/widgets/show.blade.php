...
@section('panel-title')Manage Studyabroad Widgets <small>{{ $event }}</small>@endsection
@section('content')
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-2 pull-right">
                        <a href="/admin/events/studyabroad/widgets/create/{{ $event_id }}" class="btn btn-success btn-block"><span class="fa fa-plus"></span> Add Widgets</a>
                    </div>
                    <div class="col-md-3">
                        <form method="get">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="{{ route('editStudyabroadWidgets', $widget->event_widget_sid) }}" style="cursor:pointer">Edit</a></li>
                                                        @if($widget->deleted == 0)
...
<script type="text/javascript">
    $('#deleted').on('change', function(event){
        ...
        window.open('/admin/events/studyabroad/widgets/{{ $event_id }}/filter/'+deleted, '_self')
    });
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/studyabroad/widgets/restore/'+id,
                        data: {_method: 'post'},
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/studyabroad/widgets/'+id,
                        data: {_method: 'delete'},
                            beforeSend: function(xhr) {
