...
@section('panel-title')Manage Study Abroad Attendance <small>{{ $event->title_en }}</small>@endsection
@section('content') 
        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form method="post" action="{{ route('StudyAtteExport') }}">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Study Abroad Registered Users</h3>
                </div>
                <div class="panel-body">
                    <div class="col-md-6">
                        <form method="get">
                    ...
                    <table class="table table-hover table-striped datatable">
                        ...
                        <tbody>
                                @if(isset($attendances))
                                    ...
                                    @endforeach
                                @else
                                    {{ "There is no attendances for this study abroad's" }}
                                @endif
                        </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    $('#filter').on('change', function(event){
        ...
        window.open('/admin/events/studyabroad/attendance/{{ $event_id }}/filter/'+deleted, '_self')
    });
    function notyConfirmRes(dat, id){
        noty({
            text: '<strong style="color:red">Warning!</strong><br><br>Are you sure that you want to Restore studya broad:<br> '+dat+' ?',
            layout: 'center',
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/studyabroad/attendance/restore/'+id,
                        data: {_method: 'post'},
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/studyabroad/attendance/'+id,
                        data: {_method: 'delete'},
                            beforeSend: function(xhr) {
