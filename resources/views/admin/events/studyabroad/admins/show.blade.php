...
@section('panel-title')Study Abroad Admins 
...
@section('content')
<div class="panel">
	<form class="form-horizontal" method="post" id="create_form" action="{{ route('updateStudyabroadAdmins', $event['event_id']) }}">
		...
		<div class="panel-body" id="conf_a">
		    <p>Choose from list of <strong>admins</strong> to asgin or remove admins of studyabroad.</p>
		    <div class="col-md-12">
		        <div class="col-md-6">
		            <!-- SC LIST -->
		        ...
		        <div class="col-md-6">
		            ...
		            <div class="panel panel-default">
		                <div class="panel-heading">
		                    <h3 class="panel-title">Studyabroad Admins</h3>
		                </div>
		                ...
		                @foreach($eAdmins as $eAdmin)
		                    <a style="cursor:default" class="list-group-item"  data-cond="confa" data-toggle="tooltip" data-placement="bottom" title="Click to move admin">
		                        ...
		                        <p>Study Abroad {{ $eAdmin->users->user_type->description }}</p>
