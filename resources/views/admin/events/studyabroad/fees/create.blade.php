@extends('admin.layouts.master') @section('return-url'){{route('showStudyabroadFees', $event_id)}}@endsection @section('panel-title')Create New Fees <small>{{ $event }}</small>@endsection @section('content')
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/admin/events/studyabroad/fees/store/{{ $event_id }}',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
