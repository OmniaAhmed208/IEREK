...
@section('return-url'){{route('showStudyabroadFees', $event_id)}}@endsection
@section('panel-title')Update Studyabroad Fees <small>{{ $event }}</small>
@endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateStudyabroadFees", $fee->event_fees_id) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
            ...
            success: function (response) {
                ...
                else
                {
                    ...
                    setTimeout(
                        function(){
                            window.open('/admin/events/studyabroad/fees/{{ $event_id }}', '_self');
                            $('#success').fadeOut(200);
                        }
                    ,1000);
                }
                ...
                <div class="panel panel-default">                            
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Update study abroads fees information.</p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-7 col-xs-12">
                                    <div class="input-group" id="amount">
                                        <input type="number" step="any" min="0" class="form-control" name="amount"  value="{{ $fee->amount }}" placeholder="" />
                                        <span class="input-group-addon" data-toggle="tooltip" data-placement="top" title="Amount In {{ $event_currency }}">{{ $event_currency }} <span class="redl">*</span></span>
                                    </div>
