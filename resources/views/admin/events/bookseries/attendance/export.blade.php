...
@section('panel-title') Export Book Series Attendance <small>{{$event->title_en}}</small>@endsection
@section('return-url'){{'/admin/events/bookseries/attendance/'.$event->event_id}}@endsection
@section('content')
	<div class="row">
		<div class="panel">
					...
					<table id="customers" class="table datatable">
                        ...
                        <tbody>
                                @if(isset($attendances))
                                    ...
                                    @endforeach
                                @else
                                    {{ 'There is no attendances for this bookseries filter' }}
                                @endif
                        </tbody>
					</table>
				</div>
