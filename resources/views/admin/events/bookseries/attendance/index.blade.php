...
@section('panel-title')Manage Book Series Attendance <small>{{ $event->title_en }}</small>@endsection
@section('content') 
<div class="page-content-wrap">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3>Book Series Registered Users</h3>
                </div>
                <div class="panel-body">
                    <div class="col-md-6">
                        <form method="get">
                    ...
                    <table class="table table-hover table-striped datatable">
                        ...
                        <tbody>
                                @if(isset($attendances))
                                    ...
                                    @endforeach
                                @else
                                    {{ 'There is no attendances for this bookseries' }}
                                @endif
                        </tbody>
                    </table>
                </div>
...
<script type="text/javascript">
    $('#filter').on('change', function(event){
        ...
        window.open('/admin/events/bookseries/attendance/{{ $event_id }}/filter/'+deleted, '_self')
    });
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/bookseries/attendance/restore/'+id,
                        data: {_method: 'post'},
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/bookseries/attendance/'+id,
                        data: {_method: 'delete'},
                            beforeSend: function(xhr) {
