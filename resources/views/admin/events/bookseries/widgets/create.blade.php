@extends('admin.layouts.master') @section('return-url'){{route('showBookseriesWidgets', $event_id)}}@endsection @section('panel-title')Create New Widgets <small>{{ $event }}</small>@endsection @section('content')
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/admin/events/bookseries/widgets/store/{{ $event_id }}',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
                ...
                <div class="panel panel-default">
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Fill in bookseries widgets information.</p>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Book Series Widgets created successfully !</strong> </span>
                        </div>
    ...
    <div class="panel">
        <div class="panel-body">
            <table class="table table-stripped">
                <caption>Book Series Widgets</caption>
                <thead>
                    <tr>
                        <th>Widget Title</th>
