...
@section('return-url'){{route('showBookseriesWidgets', $event_id)}}@endsection
@section('panel-title')Update Book Series Widgets <small>{{ $event['title_en'] }}</small>
@endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateBookseriesWidgets", $eventWidget->event_widget_sid) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
        processData: false,
            ...
            success: function (response) {
                ...
                else
                {
                    ...
                    setTimeout(
                        function(){
                            window.open('/admin/events/bookseries/widgets/{{ $event_id }}', '_self');
                            $('#success').fadeOut(200);
                        }
                    ,1000);
                }
                ...
                <div class="panel panel-default">                            
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Update bookseries widgets information.</p>
                            ...
                            <div class="form-group" id="widget_description">
                                ...
                                <div class="col-md-7 col-xs-12"> 
                                    <div class="input-group">
                                        <span class="input-group-addon"><span class="redl"></span></span>
                                        <textarea name="widget_description" id="widget_description_input" class="form-control" >{{ $eventWidget->widget_description }}</textarea>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Book Series Widgets updated successfully !</strong> </span>
                        </div>
