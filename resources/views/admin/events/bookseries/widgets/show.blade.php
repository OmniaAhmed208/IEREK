...
@section('panel-title')Manage Book Series Widgets <small>{{ $event }}</small>@endsection
@section('content')
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-2 pull-right">
                        <a href="/admin/events/bookseries/widgets/create/{{ $event_id }}" class="btn btn-success btn-block"><span class="fa fa-plus"></span> Add Widgets</a>
                    </div>
                    <div class="col-md-3">
                        <form method="get">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="{{ route('editBookseriesWidgets', $widget->event_widget_sid) }}" style="cursor:pointer">Edit</a></li>
                                                        @if($widget->deleted == 0)
                                ...
                                @else
                                    <tr>
                                    <td>
                                    {{ 'No Widgets for this bookseries' }}
                                    </td>
                                    <td></td>
                                    <td></td>
                                    <!--
...
<script type="text/javascript">
    $('#deleted').on('change', function(event){
        ...
        window.open('/admin/events/bookseries/widgets/{{ $event_id }}/filter/'+deleted, '_self')
    });
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/bookseries/widgets/restore/'+id,
                        data: {_method: 'post'},
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/bookseries/widgets/'+id,
                        data: {_method: 'delete'},
                            beforeSend: function(xhr) {
