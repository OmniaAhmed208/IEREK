...
@section('panel-title')Create New Book Series 
@endsection
@section('content')
        ...
        processData: false,
            ...
            success: function (response) {
                ...
                else
                {
                    ...
                    setTimeout(
                        function(){
                            window.open('/admin/events/bookseries', '_self');
                            $('#success').fadeOut(200);
                        }
                    ,1000);
                }
                            ...
                            <div class="form-group" id="event_master_id">                                        
                                ...
                                <div class="col-md-6 col-xs-12">
                                  <select class="form-control select" name="event_master_id">
                                        <option value="0" selected="selected"> Choose Conference</option>
                                        
                                      @foreach($eventmasters as $eventmaster)
                                        <option value="{{ $eventmaster->event_id }}">{{ $eventmaster->title_en }}</option>
                                      @endforeach
                                  </select>
                                </div>                                            
                            </div>
