...
@section('panel-title')Book Series Admins 
...
@section('content')
<div class="panel">
	<form class="form-horizontal" method="post" id="create_form" action="{{ route('updateBookseriesAdmins', $event['event_id']) }}">
		...
		<div class="panel-body" id="conf_a">
		    <p>Choose from list of <strong>admins</strong> to asgin or remove admins of bookseries.</p>
		    <div class="col-md-12">
		        <div class="col-md-6">
		            <!-- SC LIST -->
		        ...
		        <div class="col-md-6">
		            ...
		            <div class="panel panel-default">
		                <div class="panel-heading">
		                    <h3 class="panel-title">Book Series Admins</h3>
		                </div>
		                <div class="panel-body list-group list-group-contacts" id="confa" style="max-height:300px;overflow:auto">
		                    ...
		                    <a style="cursor:default" class="list-group-item"  data-cond="confa" data-toggle="tooltip" data-placement="bottom" title="Click to move admin">
		                        ...
		                        <p>Book Series {{ $eAdmin->users->user_type->description }}</p>
