...
@section('return-url'){{route('indexBookseries')}}@endsection
@section('panel-title')Update Book Series <small>{{ $event->title_en }} <?php if($event->deleted == 1){ echo '<b style="color:red">Deleted</b>'; } ?></small>
@endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateBookseries", $event->event_id) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
                ...
                <div class="panel panel-default tabs">                            
                    ...
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Fill in bookseries general information.</p>
                            ...
                            <div class="form-group" id="event_master_id">                                        
                                <label class="col-md-3 col-xs-12 control-label">Conference</label>
                                <div class="col-md-6 col-xs-12">
                                  <select class="form-control select" name="event_master_id">
                                        
                                      @foreach($eventmasters as $eventmaster)
                                        <option value="{{ $eventmaster->event_id }}" @if($event->event_master_id == $eventmaster['event_id']) {{ 'selected' }} @endif>{{ $eventmaster->title_en }}</option>
                                      @endforeach
                                  </select>
                                </div>                                            
                            </div>
                            ...
                            <div class="form-group" id="title_ar">
                                ...
                                <div class="col-md-6 col-xs-12">         
                                    <div class="input-group">
                                        <input type="text" class="form-control ar" value="{{ $event->title_ar }}"  name="title_ar" placeholder=""/>
                            ...
                            <div class="form-group"  id="location_ar">
                                ...
                                <div class="col-md-6 col-xs-12"> 
                                    <div class="input-group">
                                        <input type="text"  name="location_ar" value="{{ $event->location_ar }}" class="form-control ar" />
                                        <span class="input-group-addon">ع</span>
                                    </div>
                                </div>
                            </div>
                            -->
                            <div class="form-group">
                                <label class="col-md-3 col-xs-12 control-label">Book Series Dates</label>
                                <div class="col-md-6 col-xs-12">
                                    <div class="col-md-6">
                        ...
                        <div class="tab-pane fade" id="tab-Images">
                            <p>Insert Book Series Images for all following views (Cover Image, Out View Image, Slider Image and Publisher Image.</p>
