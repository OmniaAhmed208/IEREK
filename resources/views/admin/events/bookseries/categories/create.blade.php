@extends('admin.layouts.master') @section('return-url'){{route('showBookseriesCategories','all')}}@endsection @section('panel-title') Create New Book Series Category @endsection 
@section('content')
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/admin/events/bookseries/categories/store',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
            ...
            success: function(response) {
                ...
                if (success == false) {
                    ...
                    setTimeout(
                        function() {
                            window.open('/admin/events/bookseries/categories/show', '_self');
                            $('#success').fadeOut(200);
                        }, 1000);
                }
                $('#loading').fadeOut(200);
