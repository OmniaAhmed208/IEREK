...
@section('panel-title') Manage Book Series Categories @endsection
@section('content')
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-md-2 pull-right">
                        {{-- <a href="/admin/events/bookseries/categories/create" class="btn btn-success btn-block"><span class="fa fa-plus"></span> Add Category</a> --}}
                    </div>
                    <div class="col-md-3">
                        <form method="get">
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu" role="menu">
                                                        <li><a href="{{ route('editBookseriesCategories', $category->sub_category_id) }}" style="cursor:pointer">Edit</a></li>
                                                        @if($category->deleted == 0)
...
<script type="text/javascript">
    $('#deleted').on('change', function(category){
        ...
        window.open('/admin/events/bookseries/categories/filter/'+deleted, '_self')
    });
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/bookseries/categories/restore/'+id,
                        data: {_method: 'post'},
        ...
        noty({
            ...
            buttons: [
                    {addClass: 'btn btn-success btn-clean', text: 'Ok', onClick: function($noty) {
                        ...
                        $.ajax({
                        type: 'POST',
                        url: '/admin/events/bookseries/categories/'+id,
                        data: {_method: 'delete'},
                            beforeSend: function(xhr) {
