@extends('admin.layouts.master') @section('return-url'){{route('showBookseriesCategories','show')}}@endsection @section('panel-title') Update Book Series Category @endsection 
@section('content')
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '{{ route("updateBookseriesCategories", $category->sub_category_id) }}',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
