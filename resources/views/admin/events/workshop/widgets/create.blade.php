@extends('admin.layouts.master') @section('return-url'){{route('showWorkshopWidgets', $event_id)}}@endsection @section('panel-title')Create New Widgets <small>{{ $event }}</small>@endsection @section('content')
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/admin/events/workshop/widgets/store/{{ $event_id }}',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
                ...
                <div class="panel panel-default">
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            <p>Fill in workshop widgets information.</p>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Workshop Widgets created successfully !</strong> </span>
                        </div>
    ...
    <div class="panel">
        <div class="panel-body">
            <table class="table table-stripped">
                <caption>Workshop Widgets</caption>
                <thead>
                    <tr>
                        <th>Widget Title</th>
