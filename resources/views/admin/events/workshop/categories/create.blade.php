@extends('admin.layouts.master') @section('return-url'){{route('showStudyabroadCategories','all')}}@endsection @section('panel-title')Create New Study Abroad Category@endsection 
@section('content')
...
$(document).ready(function() {
    $('#create').on('click', function(event) {
        ...
        $.ajax({
            ...
            type: 'POST',
            url: '/admin/events/studyabroad/categories/store',
            data: formData,
            dataType: 'json',
            cache: false,
            contentType: false,
            ...
            success: function(response) {
                ...
                if (success == false) {
                    ...
                    setTimeout(
                        function() {
                            window.open('/admin/events/studyabroad/categories/show', '_self');
                            $('#success').fadeOut(200);
                        }, 1000);
                }
                $('#loading').fadeOut(200);
                ...
                <div class="panel panel-default">
                    <div class="panel-body tab-content">
                        <div class="tab-pane fade in active" id="tab-General">
                            ...
                            <div class="form-group" id="category_title">
                                ...
                                <div class="col-md-7 col-xs-12">
                                    <div class="input-group">
                                        ...
                                        <input type="text" name="title" id="category_title_input" class="form-control" />
                                    </div>
                            ...
                            <div class="form-group" id="category_description">
                                ...
                                <div class="col-md-7 col-xs-12">
                                    <div class="input-group">
                                        <span class="input-group-addon"> <span class="redl"></span></span>
                                        <textArea name="description" id="category_description_input" class="form-control" ></textarea>
                                    </div>
                        ...
                        <div id="success" class="alert alert-success" style="margin-top:1em; display:none;">
                            <span><strong id="welcome">Study abroad Categories created successfully !</strong> </span>
                        </div>
