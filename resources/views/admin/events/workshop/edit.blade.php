...
@section('panel-title')Update Workshop <small>{{ $event->title_en }} <?php if($event->deleted == 1){ echo '<b style="color:red">Deleted</b>'; } ?></small>
@endsection
@section('content')
...
$(document).ready( function() {
    $('#update').on('click', function(event) {
        ...
        type: 'POST',
        url: '{{ route("updateWorkshop", $event->event_id) }}',
        data: formData,
        dataType: 'json',
        cache: false,
        contentType: false,
