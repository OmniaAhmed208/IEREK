...
@section('panel-title') Export Workshop Attendance <small>{{$event->title_en}}</small>@endsection
@section('return-url'){{'/admin/events/workshop/attendance/'.$event->event_id}}@endsection
@section('content')
	<div class="row">
		<div class="panel">
					...
					<table id="customers" class="table datatable">
                        ...
                        <tbody>
                                @if(isset($attendances))
                                    ...
                                    @endforeach
                                @else
                                    {{ 'There is no attendances for this workshops filter' }}
                                @endif
                        </tbody>
					</table>
				</div>
