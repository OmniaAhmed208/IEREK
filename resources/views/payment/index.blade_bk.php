                                ...
                                <div class="">
                                    <div class="panel">
                                        <div class="panel-heading">
                                            @if($event->slug == 'HICPS2022')
                                            <h4>Estimated Quotation&ensp;&ensp;<small
                                        ...
                                        <div class="panel-body">
                                            ...
                                            @if($event->slug == 'HICPS2022')
                                                <h3>To calculate payment due for this account:</h3>
                    ...
                    <div class="col-md-8 checkout" style="display:none">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                @if($event->slug == 'HICPS2022')
                                <a href="https://secure.2checkout.com/checkout/buy?merchant=102563668&currency=USD&tpl=default&review=1&prod=37%3B38%3B35%3B36%3B40%3B42%3B41&qty=1%3B1%3B1%3B1%3B1%3B1%3B1"  target="_blank">
                                ...
                                <div class="bankform" style="display:none;">
                                    ...
                                    <!--                            <input type="hidden" name="currency" value="{{$event->currency}}">-->
                                        ...
                                        <div class="box-content">
                                            <p>
                                                <b style="color:#aa822c">USD Account:</b><br>
                                                Account Number:  100023143814<br>
                                                IBAN Number: EG950010005600000100023143814<br><br>
                                                <b style="color:#aa822c">EUR Account:</b><br>
                                                Bank Account: 100023143822<br>
                                                IBAN: EG730010005600000100023143822<br><br>
                                                <b style="color:#aa822c">GBP Account:</b><br>
                                                Bank Account: 100027093878<br>
                                                IBAN: EG610010005600000100027093878<br>
                </p>
                
                <u>Please use the information below for each of these accounts:</u><br>
                Company name: IEREK<br>
                Bank Name: Commercial International Bank (CIB) – Egypt S.A.E<br>
                Bank Address: 649 Elhoreya Road, Louran<br>
                Company Address: 649 EL Horreya Rd, Janaklis, Elraml, Alexandria, Egypt<br>
                SWIFT/BIC: CIBEEGCX044<br>
                Reason for Transaction: “[Conference Acronym - Date] [Participant name]”<br>



                <h4 style="color:red;">**NOTE*: The transaction fee is solely the participants' responsibility.</h4><br>
                                            <u>After you have completed the payment, kindly do the following:</u>
                                            <br>
                                            1- Inform us with all the transaction details.<br>
                                            2- After you make your transfer, kindly send us a scanned copy of the receipt to the conference coordinator’s email (conference page) and CC <a href="mailto:financialservices@ierek.com">financialservices@ierek.com</a>.<br>
                                            3- Your participation will be confirmed but payment will be marked as “pending” until confirmation is received from the bank.<br>
                                            4- For further assistance/ to request a payment invoice, contact us at 
                                            <a href="mailto:financialservices@ierek.com">financialservices@ierek.com</a>.
                                ...
                                <div>
                                    <div class="group">
                                        ...
                                        <div>
                                            ...
                                            <input type="hidden" id="custom_money">
                                            <h6>To request a customized online payment link, contact us. </h6>

                                        </div>

                                    </div>
                                    <div class="group">
                                        <a href="mailto:financialservices@ierek.com?subject=Online%20Payment%20Link"
                                           class="btn btn-success btn-block alt-link btn-full-width-mob"
                                           style="font-size:18px; ">Request Link&ensp;<i
                                                    class="glyphicon glyphicon-chevron-right"></i></a>
                                    </div>
                                </div>
                            </div>
